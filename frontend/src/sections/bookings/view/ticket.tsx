...
const Ticket: React.FC<TicketProps> = ({ user, reservation, onClose }) => (
  <>
    <div className="close-container">
      <button type="button" className="item-1" onClick={onClose}>
    ...
    <div className="ticket">
      <div className="ticket-top">
        <div className="ticket-header">
          <div className="head-logo">Quick Ride Bus</div>
          <div className="head-flight">{(reservation as any)?.schedule?.bus?.bus_name}</div>
        </div>
